...
public class MyLinkedListImproved<T extends Comparable<T>> implements Iterable<T>{
	...
	public static void radixsort(MyLinkedListImproved<Integer> data){
	    int numOfDigits= Math.log10(data.max());
	    @SupressWarnings ("unchecked") MyLinkedListImproved<Integer>[] digits = new MyLinkedListImproved[10];
	    for (int place=1;place<numOfDigits; place++){
